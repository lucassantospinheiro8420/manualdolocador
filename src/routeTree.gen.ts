...
const Hbase87Route = Hbase87RouteImport.update({
  id: '/hbase87',
  path: '/hbase87',
  getParentRoute: () => rootRouteImport,
} as any)
const Hbase47Route = Hbase47RouteImport.update({
  id: '/hbase47',
  path: '/hbase47',
  getParentRoute: () => rootRouteImport,
} as any)
const Hbase27Route = Hbase27RouteImport.update({
  id: '/hbase27',
  path: '/hbase27',
  getParentRoute: () => rootRouteImport,
} as any)
...
declare module '@tanstack/react-router' {
  interface FileRoutesByPath {
    ...
    '/hbase87': {
      ...
      path: '/hbase87'
      fullPath: '/hbase87'
      preLoaderRoute: typeof Hbase87RouteImport
      parentRoute: typeof rootRouteImport
    }
    '/hbase47': {
      id: '/hbase47'
      path: '/hbase47'
      fullPath: '/hbase47'
      preLoaderRoute: typeof Hbase47RouteImport
      parentRoute: typeof rootRouteImport
    }
    '/hbase27': {
      id: '/hbase27'
