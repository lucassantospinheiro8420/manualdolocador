...
function VslPage() {
  ...
  return (
    <div className="min-h-screen bg-white text-neutral-900">
      {/* TARJA */}
      <div className="w-full bg-red-600 px-4 py-2.5 text-center">
      ...
      <main className="mx-auto w-full max-w-[600px] px-5 pb-12 pt-7 sm:pt-9">
        {/* REDLINE */}
        <h1 className="text-center text-[27px] font-bold leading-[1.18] tracking-tight sm:text-[34px]">
          Eu te mostro neste vídeo as 4 coisas que fazem um carro parado te
          pagar R$3.000 por mês.
        </h1>

        {/* SUB */}
        <p className="mx-auto mt-4 max-w-[520px] text-center text-[15px] leading-relaxed text-neutral-600 sm:mt-5 sm:text-base">
          Comecei com 40 mil de dívida. Hoje são 50 carros na rua, 47
          financiados.
        </p>
