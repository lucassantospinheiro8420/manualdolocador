...
// Checkout da OFERTA R$87 (braco B do teste de preco). O /Hbase controle NAO foi tocado: segue no
// CHECKOUT_URL padrao do CTAButton (oferta R$67).
...
const CHECKOUT_87 = "https://pay.assiny.com.br/-Ehslv/node/tS-ut0?utm_source=trafego-pago";
...
export const Route = createFileRoute("/hbase87")({
  component: SalesPage,
  head: () => ({
    meta: [
    ...
    <div className="min-h-screen bg-background text-foreground overflow-x-hidden">
            ...
            <div className="flex-1 w-full">
              <div className="bg-card border border-primary/40 rounded-2xl p-5 shadow-elevated">
                ...
                <div className="mt-5 pt-4 border-t-2 border-primary/30 text-center">
                  ...
                  <p className="text-xs text-muted-foreground mb-5">à vista · ou 12x de R$9,00</p>
                  ...
                  <CTAButton id="cta-oferta" href={CHECKOUT_87}>QUERO ACESSAR AGORA</CTAButton>
      ...
      <section className="px-4 py-16">
        <div className="max-w-2xl mx-auto text-center">
          ...
          <p className="text-7xl font-bold text-success mb-2">R$87</p>
          <p className="text-xs text-muted-foreground mb-6">à vista · ou 12x de R$9,00</p>
          <CTAButton id="cta-final" href={CHECKOUT_87}>SIM! QUERO O MANUAL</CTAButton>
      ...
      <section className="px-4 py-14">
        <div className="max-w-2xl mx-auto text-center">
          ...
          <p className="text-7xl font-bold text-success mb-2">R$87</p>
          <p className="text-xs text-muted-foreground mb-6">à vista · ou 12x de R$9,00</p>
          <CTAButton id="cta-final-2" href={CHECKOUT_87}>QUERO COPIAR O MANUAL</CTAButton>
