...
// Checkout da OFERTA R$27 (teste de preco na pagina direta). O /Hbase controle NAO foi tocado:
// segue no CHECKOUT_URL padrao do CTAButton (oferta R$67).
// MEDIDO 2026-09-02 no navegador: quem escreve o utm_source que CHEGA no checkout e a UTMify
// (cdn.utmify.com.br/scripts/utms/latest.js), NAO esta constante. Com UTM de anuncio na pagina ela
// grava a real (fb/ig); sem UTM nenhuma ela grava "organic". O valor abaixo so sobrevive se a UTMify
// nao carregar (adblock), e como esta slug so recebe trafego pago, e esse o rotulo certo pro caso.
const CHECKOUT_27 = "https://pay.assiny.com.br/KwJqZ0/node/zs-Elt?utm_source=trafego-pago";
...
export const Route = createFileRoute("/hbase-v2")({
  component: SalesPage,
  head: () => ({
    meta: [
    ...
    <div className="min-h-screen bg-background text-foreground overflow-x-hidden">
      ...
      <section className="relative px-5 pt-6 pb-8 sm:pt-10 sm:pb-12">
        <div className="relative max-w-2xl mx-auto text-center fade-up">
          ...
          {/* PRECO NO HERO (variacao /hbase-v2): o lead ve o valor antes da pilha, entao e "De X por", nunca "Valor total" */}
          <div className="mt-6 text-center">
            <p className="text-sm text-muted-foreground mb-1">De <span className="line-through">R$ 697</span> por apenas:</p>
            <p className="text-6xl sm:text-7xl font-bold text-success leading-none my-2">R$27</p>
            <p className="text-xs text-muted-foreground">à vista · ou 6x de R$5,07</p>
          </div>
        </div>
      </section>
            ...
            <div className="flex-1 w-full">
              <div className="bg-card border border-primary/40 rounded-2xl p-5 shadow-elevated">
                ...
                <div className="mt-5 pt-4 border-t-2 border-primary/30 text-center">
                  ...
                  <p className="text-xs text-muted-foreground mb-5">à vista · ou 6x de R$5,07</p>
                  ...
                  <CTAButton id="cta-oferta" href={CHECKOUT_27}>QUERO ACESSAR AGORA</CTAButton>
      ...
      <section className="px-4 py-16">
        <div className="max-w-2xl mx-auto text-center">
          ...
          <p className="text-sm text-muted-foreground mb-1">De <span className="line-through">R$ 697</span> por apenas:</p>
          <p className="text-7xl font-bold text-success mb-2">R$27</p>
          <p className="text-xs text-muted-foreground mb-6">à vista · ou 6x de R$5,07</p>
          <CTAButton id="cta-final" href={CHECKOUT_27}>SIM! QUERO O MANUAL</CTAButton>
      ...
      <section className="px-4 py-14">
        <div className="max-w-2xl mx-auto text-center">
          ...
          <p className="text-7xl font-bold text-success mb-2">R$27</p>
          <p className="text-xs text-muted-foreground mb-6">à vista · ou 6x de R$5,07</p>
          <CTAButton id="cta-final-2" href={CHECKOUT_27}>QUERO COPIAR O MANUAL</CTAButton>
